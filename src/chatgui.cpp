...
ChatBotPanelDialogItem::ChatBotPanelDialogItem(wxPanel * parent, wxString
text,
bool isFromUser
)
:
wxPanel(parent,
-1, wxPoint(-1, -1), wxSize(-1, -1), wxBORDER_NONE)
{
...
_chatBotTxt->
SetForegroundColour(isFromUser
== true ?
wxColor(*wxBLACK)
:
wxColor(*wxWHITE)
...
this->
SetBackgroundColour((isFromUser
== true ? wxT("YELLOW") : wxT("BLUE")));
}
